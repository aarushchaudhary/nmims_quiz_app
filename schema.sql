...
CREATE TABLE `quizzes` (
  ...
  `negative_marks_mcq`         DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  `negative_marks_msq`         DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  `negative_marks_descriptive` DECIMAL(5,2) NOT NULL DEFAULT 0.00,
  `created_at`                 TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at`                 TIMESTAMP    NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
